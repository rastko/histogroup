...
// Version     : 3.0.1
// Copyright   : Copyright 2014 Stipple, Inc. - All Rights Reserved
...
int histogroup::compute_image_hash(const char *filename, float* &hash, \
    ...
    if( original_image.spectrum() != 3 && original_image.spectrum() != 4 ) {
        fprintf(stderr, "compute_image_hash() : Loaded image spectrum != 3 or 4, so inappropriate for 3D histogram!\n");
        return -4;
    }
